...
public sealed class CreateIdentityNodeTests : Data.IDataProviderTests
{
    [TestMethod]
    public async Task IdentityDataProvider_CreateIdentityNode_HappyPath_ShouldBeSuccessful(
    )
    {
        // Arrange
    ...
    [TestMethod]
    public async Task IdentityDataProvider_CreateIdentityNode_DatabaseException_ShouldThrowException(
    )
    {
        // Arrange
